...
- user can set any context size number, bounded by this model's own usable range
  (Min CTX size … Max CTX size, below)
...
- Big CTX size is size where model can work on 90% of its quality without
